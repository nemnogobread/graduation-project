...
if __name__ == "__main__":
    ...
    massive_data = {}
    data_x = [0 for i in range(17)]
    data_y_COM5 = [0 for i in range(17)]
    data_y_COM6 = [0 for i in range(17)]
    h = 21 * 1e-3
    ...
    plt.plot(data_x, data_y_COM5, label="COM5")
    plt.plot(data_x, data_y_COM6, label="COM6")
    plt.legend()
    plt.grid(True)
    plt.show()