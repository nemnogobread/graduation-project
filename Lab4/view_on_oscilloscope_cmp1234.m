function y=view_on_rigol_dp2031 %(name, vc, directory)
close all

cd('E:\Elena\Tektronix')
!python readfromdpo_binary_multiple_channels_cmd.py E:/Elena/Pulses/210823/ buff 1 1000000 CH1 CH2 CH3 CH4
cd(directory);
% cd('G:\РНФ\15.06.2022\СШП когерентные излучатели\Сложение в пространстве 20.09.2024\8_ant_10.10.24')
